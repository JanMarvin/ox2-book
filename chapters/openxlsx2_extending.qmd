...
## `spaghetti` - Helpers for spreadsheet formulas
...
# XLOOKUP: look up the first sales value for each unique product using the spill
...
wb <- wb |>
  ...
  wb_add_formula(
    dims = "F2",
    x = spaghetti::to_xml("=SUM(XLOOKUP(E2#, B2:B7, C2:C7, 0, 0))"),
    cm = TRUE
  )
