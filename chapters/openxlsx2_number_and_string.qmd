...
wb$add_data(dims = dims_2, x = mm, na = NULL)$add_border(dims = dims_2)
# writes the string N/A
wb$add_data(dims = dims_3, x = mm, na = "N/A")$add_border(dims = dims_3)
```
