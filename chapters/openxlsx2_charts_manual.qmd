...
There is a branch with a [`ms_combochart()`](https://janmarvin.r-universe.dev/mschart/doc/manual.html#ms_combochart) function that allows for a second horizontal or vertical axis at <https://github.com/JanMarvin/mschart/tree/sec_y_axis>.
