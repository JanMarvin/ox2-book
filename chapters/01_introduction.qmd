...
webr::install(
   'openxlsx2',
   repos = c(
     'https://janmarvin.r-universe.dev',
...
```{webr-r}
readLines(system.file("AUTHORS", package = "openxlsx2"))
```
