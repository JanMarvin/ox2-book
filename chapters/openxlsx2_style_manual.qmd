...
A neat example of this is the following: a user wanted to lock certain cells on a worksheet. To acchieve this, we have to apply an unlocked style to the entire worksheet. Afterwards we cann select a few cells that we want to lock.
